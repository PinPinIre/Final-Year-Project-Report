...
Up until version 0.11 the coherence of Gensim topics was analysed by manually evaluating the topics generated.
...
For this reason the time to preprocess LDA and k-NN is presented in Figure TODO.
...
The time taken to train LDA, k-NN and Word2Vec is presented in Figure TODO.
