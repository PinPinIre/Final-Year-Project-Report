...
Content-filtering is an approach used by recomdation systems which tries to learn about the content of items in order to generate recomdations for similar content.

The research conducted in this project is focused entirely on the information retrival component of a content-filtering recomendation system.
